                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <!-- Botones "+" y "-" para agregar y restar cantidad -->
                                        <button class="btn btn-success" onclick="agregarCantidad(this)">+</button>
                                        <span class="cantidad">0</span>
                                        <button class="btn btn-danger" onclick="restarCantidad(this)">-</button>
                                    </td>
                                </tr>
                            <?php
                            }
